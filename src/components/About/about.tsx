...
export default function About() {
    ...
    return (
      <div className="max-w-6xl mx-auto p-4 mt-10">
        <div className="bg-green-600 text-white rounded-lg  py-4 px-5 text-center text-xl font-bold border-2 border-white shadow-lg">
          কেন <span className="text-yellow-400">DEXE BLACK HAIR SHAMPOO</span> কিনবেন
        </div>
        <ul className="mt-5 divide-y divide-gray-300 bg-white rounded-lg px-5" >
          {reasons.map((reason, idx) => (
            <li key={idx} className="flex items-start gap-2 py-3 px-4">
